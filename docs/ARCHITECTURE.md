...
list/task acknowledgement, and ordered Google create publication are implemented
through S15A. Retry, Android lifecycle control and non-create reconciliation remain
later slices.**
